    ...
    <>
      ...
      {isMenuMounted && (
        <ul
          className={cn(
            styles.menu,
            'flex flex-col absolute bg-gray-100 dark:bg-gray-800 ',
            isMenuRendered && styles.menuRendered
          )}
        >
          <li
            className="border-b border-gray-300 dark:border-gray-700 pl-4 text-gray-900 dark:text-gray-100 text-sm font-semibold"
          ...
          <li
            className="border-b border-gray-300 pl-4 dark:border-gray-700 text-gray-900 dark:text-gray-100 text-sm font-semibold"
...
function CrossIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg
      className="h-5 w-5 absolute text-green-900 dark:text-gray-100"
      viewBox="0 0 24 24"
      width="24"
      height="24"
      stroke="currentColor"
